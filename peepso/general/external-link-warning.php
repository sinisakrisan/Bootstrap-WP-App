...
<div class="ps-redirect__box">
	<div class="ps-redirect__box-body">
		<div class="alert alert-danger">
			<i class="fa fa-exclamation-triangle"></i><?php echo sprintf(__('The link you just clicked redirects to: <span class="ps-redirect__link"><kbd>%s</kbd></span>', 'peepso-core'), $url_link); ?>
		</div>
		<p><?php echo __('Do you want to continue?', 'peepso-core'); ?></p>
	</div>
	<div class="ps-redirect__box-actions">
		<a role="button" class="btn" href="<?php echo $back;?>"><?php echo __('No, take me back', 'peepso-core'); ?></a>
		<a role="button" class="btn btn-primary" href="<?php echo $url; ?>"
